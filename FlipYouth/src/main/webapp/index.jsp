...
<body>
	...
	<div class="container">
		...
		<div><a	href="<c:url value='/pages/memberIndex.jsp'/>" >會員中心</a></div>
		</figcation></figure>

		<figure> <img
			src="https://d13yacurqjgara.cloudfront.net/users/220419/screenshots/1678299/shot-7.jpg"
			alt="Thumb" width="400" height="300" /> <figcaption>
		<div><a href="<c:url value="/events/eventing.controller"/>?mbrSN=${loginOK.mbrSN}">我的揪團</a></div>
		</figcation></figure>
		...
		<figure> <img
			...
			alt="Thumb" width="400" height="300" /> <figcaption>
		<div><a href="<c:url value='/Tim/page/FlipYouthStore.jsp'/>">翻桌唷&nbsp商城</a></div>
		</figcation></figure>
		...
		<figure> <img
			...
			alt="Thumb" width="400" height="300" /> <figcaption>
		<div><a	href="<c:url value='/searchRelation.controller' />">&nbsp我的好友&nbsp</a></div>
		</figcation></figure>
